...
func TestHandleFloodFill(t *testing.T) {
	...
	t.Run("canvas not found, should create new canvas", func(t *testing.T) {
		...
		req := httptest.NewRequest(http.MethodPut, "/canvas/canvas#1/floodFill", bytes.NewBuffer(reqData))
		...
		New(mockStorage, time.Hour).HandleFloodFill(rr, req)
